...
(function($){
    ...
    $.fn.playerConnect = function(player){
        ...
        player.on('time', function(evt){
                ...
                // YOUR CODE TO ADD #3
            $.each(transcriptElements, function (index) {
                var start = parseFloat(transcriptElements[index].getAttribute("data-start"));
                var dur = parseFloat(transcriptElements[index].getAttribute("data-dur"));
        ...
        return this.click(function(evt){
          ...
          var Data = parseFloat(this.getAttribute("data-start"));
          player.seek(Data);
